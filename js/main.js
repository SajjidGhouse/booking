document.addEventListener('alpine:init', () => {
    Alpine.data('ticket', () => ({
        ...
        oAdventure : localStorage.getItem('adventure'),
        ...
        localadveture(){
            getadventure = localStorage.getItem('adventure');
            if(getadventure === null){
                adventure = this.AdeventureCount();
                return localStorage.setItem('adventure',adventure);
            }else{
                adventure = parseInt(getadventure) + parseInt(this.AdeventureCount());
                return localStorage.setItem('adventure',adventure);
            }
        }, 
